...
fn basic_osu() {
    ...
    test_cases! {
        Osu: OSU {
            NM => {
                aim: 3.279913256279356,
                aim_difficult_slider_count: 191.74178188637538,
                speed: 2.453809362675739,
                reading: 0.8231356111646012,
                reading_difficult_note_count: 34.92251595856373,
                flashlight: 0.0,
                slider_factor: 0.9710195249131963,
                speed_note_count: 170.12348293267488,
                aim_difficult_strain_count: 131.3143998835122,
                ...
                n_large_ticks: 15,
                n_spinners: 1,
                stars: 5.979924440561724,
                max_combo: 909,
                aim_top_weighted_slider_factor: 1.5062920868028942,
