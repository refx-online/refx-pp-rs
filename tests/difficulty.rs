...
fn basic_osu() {
    ...
    test_cases! {
        Osu: OSU {
            NM => {
                aim: 3.290936039050577,
                aim_difficult_slider_count: 184.30315190828563,
                speed: 2.453809362675739,
                reading: 0.861084743634359,
                reading_difficult_note_count: 32.758415157949635,
                flashlight: 0.0,
                slider_factor: 0.9663802412677,
                speed_note_count: 170.12348293267488,
                aim_difficult_strain_count: 117.69473636259998,
                speed_difficult_strain_count: 77.7120714323051,
                ar: 9.3,
                great_hit_window: 26.5,
                ok_hit_window: 51.5,
                meh_hit_window: 111.5,
                hp: 5.0,
                n_circles: 307,
                n_sliders: 293,
                n_large_ticks: 15,
                n_spinners: 1,
                stars: 5.996517116630735,
                max_combo: 909,
                aim_top_weighted_slider_factor: 1.5194270503880947,
                speed_top_weighted_slider_factor: 0.5596003159752935,
                legacy_score_base_multiplier: 5.0,
                maximum_legacy_combo_score: 15729840.0,
                nested_score_per_object: 34.99168053244592,
            };
            HD => {
            ...
            HR => {
                ...
                aim_difficult_strain_count: 110.36268364619218,
                speed_difficult_strain_count: 74.38028411571828,
                ar: 10.0,
            ...
            DT => {
                ...
                aim_difficult_strain_count: 131.99185581761657,
            ...
            FL => {
                ...
                aim_difficult_strain_count: 109.75990144179136,
